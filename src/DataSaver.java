...
public class DataSaver {
    ...
    public static void main(String[] args) {
        ...
        while (addMore) {
            ...
            String firstName = SafeInput.getNonZeroLenString(scanner, "Please enter First Name");
            String lastName = SafeInput.getNonZeroLenString(scanner, "Please enter Last Name");
            ...
            addMore = SafeInput.getYNConfirm(scanner, "Would you like to add another record?");
        }

        String fileName = SafeInput.getNonZeroLenString(scanner, "Please enter the file name to save (without .csv)") + ".csv";
