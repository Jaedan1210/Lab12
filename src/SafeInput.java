...
public class SafeInput {
    ...
    public static String getRegExString(Scanner pipe, String prompt, String regEx) {
        ...
        do {
            ...
            if (input.matches(regEx)) {
                ...
                System.out.println("Invalid input. Please ensure that the input matches the required format.");
            }
        } while(!validInput);
    ...
    public static void main(String[] args) {
        ...
        String userInput = getNonZeroLenString(scanner, "Please enter your name");
        System.out.println("You entered: " + userInput);
        int userInt = getInt(scanner, "Please enter an integer");
        System.out.println("You entered the integer: " + userInt);
        double userDouble = getDouble(scanner, "Please enter a double");
        System.out.println("You entered the double: " + userDouble);
        int rangedInt = getRangedInt(scanner, "Please enter a number", 10, 20);
        System.out.println("You entered the number: " + rangedInt);
        double rangedDouble = getRangedDouble(scanner, "Please enter a number", 5.5, 10.5);
        System.out.println("You entered the number: " + rangedDouble);
        boolean confirm = getYNConfirm(scanner, "Would you like to continue?");
        System.out.println("You selected: " + (confirm ? "Yes" : "No"));
        String regExInput = getRegExString(scanner, "Please enter a valid email", "^[A-Za-z0-9+_.-]+@[A-Za-z0-9.-]+$");
